...
public class RoundCornersImageView extends ImageView {
    ...
    //是否为上半部分圆角
    private boolean mIsRoundCornersUpper = false; 
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        mIsRoundCornersUpper = a.getBoolean(R.styleable.roundCornersImageView_is_round_cornersup,mIsRoundCornersUpper);
        if (mIsRoundCorners || mIsRoundCornersUpper) {
            mPaint = new Paint();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //获取bitmap
//        GetBitmap bt = ((BitmapDrawable) drawable).getBitmap();
